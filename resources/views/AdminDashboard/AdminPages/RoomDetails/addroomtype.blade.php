...
<body class="flex items-center justify-center min-h-screen bg-gray-100">
    <div class="w-full max-w-md bg-white p-6 rounded-lg shadow-md">
        ...
        <form id="roomTypeForm" class="flex space-x-2 mb-4">
            <input type="text" id="roomTypeName" placeholder="Enter Room Type" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
